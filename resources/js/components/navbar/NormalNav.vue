                                ...
                                <b-form @submit.prevent="handleSubmit(loginSubmit)">
                                    ...
                                    >
                                        ...
                                        <b-form-group
                                            ...
                                            label="Email"
                                            label-for="email">
                                            <b-form-input id="email" name="email" v-model="loginCredentials.email"
                                ...
                                <b-form @submit.prevent="handleSubmit(signUpSubmit)">
                                    ...
                                    >
                                        ...
                                        <b-form-group
                                            ...
                                            label="Email"
                                            label-for="s_email">
                                            <b-form-input id="s_email" name="email" v-model="signupCredentials.email"
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <label for="work" class="t-bold jb-l-special ">
                                            <input type="radio" name="work-or-hire-1" id="work" class="special-radio"
                                                   v-model="signupCredentials.preference" value="work"> Work
                                        </label>

                                        <label for="hire" class="t-bold jb-l-special">
                                            <input type="radio" name="work-or-hire-2" id="hire" class="special-radio"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <p class="text-left jb-t-special">By clicking this
                                                    button, you agree
                                                    to our <a href="" class="t-orange">Terms and conditions</a> of use
                                                </p>
                                            </div>
