                            ...
                            <div class="jb-dash-right">
                                            ...
                                            <div class="jb-dash-profile-credit">
                                                ...
                                                <p class="t-mont t-bold t-white">₵ {{user.wallet.balance}}
                                                    <span> <router-link :to="{name:'AddFunds'}"
                                                                        class=" t-normal">Add Funds</router-link></span>
                                                </p>
                                            </div>
                                ...
                                <div class="jb-dash-quick-links has-text-centered">
                                    ...
                                    <router-link to="/projects"
                                        ...
                                        <b-button class="button is-black t-white" expanded>View All Ongoing Projects
                                        </b-button>
                                    </router-link>
                                </div>
                        ...
                        <div class=" column is-12 mt-5 mt-md-0">
                            ...
                            <div v-if="profileType ==='hire' || profileType ==='work&hire'" class="jb-quick-projects">
                                ...
                                <div class="has-text-centered"
                                    ...
                                    <router-link :to="{name:'Projects',params:{owner:'me'}}" class="button bg-orange ">
                                        View
                                        All
                                    </router-link>
                                </div>
                            ...
                            <div
                                v-if="assignedProjects.length>0 &&(profileType ==='work' || profileType ==='work&hire')"
                            ...
                            <div
                                v-if="assignedProjects.length<1 && (profileType ==='work' || profileType ==='work&hire')"
                                class="jb-quick-projects">
                                <div class="jb-quick-projects-header">
                                ...
                                <div class="has-text-centered" v-if="someProjects.length >0">
                                    <router-link :to="{name:'Projects'}" class="button bg-orange">View More
                                    </router-link>
                                </div>
